          ...
          <div ref={outSideRef} className="flex-grow flex flex-col gap-2">
            <div className="flex justify-between items-center">
              <input
                ...
                className={`mr-3 pr-3 rounded w-full focus:outline-none text-gray-700 font-bold $${
                  openInputChange1
                    ? "bg-blue-100 border border-blue-600"
                    : "border-none cursor-pointer"
                }`}
                type="text"
                disabled={!openInputChange1}
                defaultValue={url?.link}
                name="linkName"
              />
              <img
                onClick={() => setOpenInputChange1(!openInputChange1)}
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center w-full gap-4">
                ...
                <input
                  ...
                  className={`mr-3 pr-3 rounded w-full text-sm focus:outline-none text-blue-600 ${
                    openInputChange2
              ...
              <img
                onClick={() => setOpenInputChange2(!openInputChange2)}
                className="w-3 cursor-pointer"
                src={edit}
                alt=""
              />
              ...
              >
                <div
                  className={`h-5 w-5 rounded-full shadow-md transform duration-300 ease-in-out
                                ${
                                  linkToggle
                                    ? "bg-green-600 transform translate-x-5"
                                    : "bg-gray-500"
                                }`}
                ></div>
              </div>
