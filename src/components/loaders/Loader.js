...
const Loader = () => {
    return (
        <div className='fixed z-40 min-h-screen min-w-full left-0 right-0 top-0 w-full h-full bg-sky-800 bg-opacity-75 flex justify-center items-center cursor-pointer zoom-in'>
