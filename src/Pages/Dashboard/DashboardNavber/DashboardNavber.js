        ...
        <nav ref={dropdownRef} className='py-10 text-white cursor-pointer max-w-[1440px] mx-auto px-4 md:px-12'>
            ...
            <div className='flex justify-between lg:gap-8 items-center text-[18px]'>
                ...
                <div className='flex justify-between items-center gap-8'>
                    ...
                    <Link to='/' className='hidden lg:block lg:flex justify-between ga--4 items-center bg-[#393AA7] h-12 px-6 rounded-[50px]'>
                    ...
                    <div onClick={() => setViewProfile(!viewProfile)} className='relative'>
