...
const Links = () => {
    ...
    return (
        <section ref={dropdownRef} className='flex justify-center items-center'>
            <div className='flex justify-center items-center gap-2 md:gap-2 cursor-pointer w-full lg:w-[980px] mx-auto'>
                ...
                <div onClick={() => setViewTab(6)}
                    className={`hidden md:block md:flex flex-col items-center py-2 rounded-md w-24
                    ${viewTab === 6 && 'bg-blue-50'}`}>
                    <div
                        className={`bg-gray-200 rounded-full flex justify-center items-center w-12 h-12
                    ${viewTab === 6 && 'bg-blue-600'}`}>
                ...
                <div onClick={() => setViewMore(!viewMore)}
                    className={`relative md:hidden flex flex-col items-center py-2 rounded-md w-24
                    ${viewMore && 'bg-blue-50'}`}>
                    <div
                        className={`bg-gray-200 rounded-full flex justify-center items-center w-12 h-12
                    ${viewMore && 'bg-blue-600'}`}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
