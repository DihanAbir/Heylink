        ...
        <section className='bg-[#393AA7] min-h-screen pb-6'>
            ...
            <div className='px-4'>
                <div className='bg-white rounded-2xl md:w-[500px] mx-auto p-6'>
                    <h1 className='text-3xl font-semibold text-gray-900 text-center'>Get started for free</h1>
                    ...
                    <form onSubmit={handleSubmit(handleSignup)} className='' >
                        ...
                        <div className='my-4'>
                            <TextField {...register('username', { required: 'username is required' })}
                                className='w-full' id="username" label="username" variant="standard" />
                            {errors.username && <div className='bg-red-200 h-6 w-full flex justify-end items-center'>
                                <p className='text-gray-900 text-sm py-3 px-2'>{errors.username.message}</p>
                            </div>}
                        </div>

                        <div className='my-4'>
                            <TextField {...register('password', { required: 'password is required' })}
                                className='w-full' id="password" label="password" variant="standard" />
                            {errors.password && <div className='bg-red-200 h-6 w-full flex justify-end items-center'>
                                <p className='text-gray-900 text-sm py-3 px-2'>{errors.password.message}</p>
                            </div>}
                        </div>
                        ...
                        <div>
                            <p className='text-center text-sm text-gray-600'>Or sign up with Google or Facebook</p>
                        </div>
                    </form>
                    {/* ---------signup form end--------- */}
                    ...
                    <div className='mt-4 cursor-pointer'>
                        <div className='flex justify-center items-center gap-3 py-3 px-4 shadow shadow-gray-400 rounded-[50px]'>
                            <img className='w-6' src="https://cdn-f.heylink.me/static/media/ic_google.f9a3cace.svg" alt="" />
                    ...
                    <div className='mt-4 cursor-pointer'>
                        <div className='flex justify-center items-center gap-3 py-3 px-4 shadow shadow-gray-400 rounded-[50px]'>
                            <img className='w-6' src="https://cdn-f.heylink.me/static/media/ic_facebook.9b9eb9fd.svg" alt="" />
                            <h1 className='flex items-center gap-2'>
                                <span>Signup With</span>
                    ...
                    <div className='mt-6'>
                        <h1 className='text-sm text-gray-600 text-center'>Already have an account? <Link to='/login' className='underline text-blue-600'>Log In</Link></h1>
                    </div>
                </div>
            </div>
        </section>
