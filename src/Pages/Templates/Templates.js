    ...
    return (
        <section className='bg-[#393AA7]'>
            ...
            <div className='relative'>
                <div ref={dropdownRef} className='relative md:hidden mt-8 flex justify-center pb-56'>
                ...
                {/* only medium device  */}
                <div className='hidden md:block md:grid md:grid-cols-6 gap-4 max-w-fit mx-auto mt-8 pb-56'>
                    {
                        templetes.map(tem => {
                            return (
                ...
                <div className='bg-white min-h-screen'>
                    <div className='grid grid-cols-4 gap-16 absolute top-44 cursor-pointer'>
                        <div className='flex flex-col items-center py-6 w-72 border-4 bg-slate-600 border-white rounded-3xl'>
